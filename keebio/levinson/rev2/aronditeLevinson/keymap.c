...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |-----+-----+-----+-----+-----+-----|              |-----+-----+-----+-----+-----+-----|
     * | Lctr| Lgui| Lalt| _NUM| _NAV| Spc |              | Ent | _SYM| _FUN| _MIS| _GAM| _QWR|
     * `-----------------------------------'              `-----------------------------------'
     */
    ...
    KC_LCTL,KC_LGUI,KC_LALT,MO(_NUM),MO(_NAV),KC_SPC,    KC_ENT,MO(_SYM),MO(_FUN),MO(_MIS),TG(_GAM),TG(_QWR)
    ),
     ...
     * `-----------------------------------'              `-----------------------------------'
     */
    KC_TRNS,KC_Q,   KC_W,   KC_E,   KC_R,   KC_T,          KC_Y,  KC_U,   KC_I,   KC_O,   KC_P,   TG(_GAM),
    KC_TRNS,KC_A,   KC_S,   KC_D,   KC_F,   KC_G,          KC_H,  KC_J,   KC_K,   KC_L,   KC_SCLN,KC_TRNS,
    KC_TRNS,KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,          KC_N,  KC_M,   KC_COMM,KC_DOT, KC_SLSH,KC_RSFT,
    KC_TRNS,KC_TRNS,KC_TRNS,KC_TRNS,MO(_GAMFUN),KC_TRNS,KC_TRNS,  MO(_GAMNUM),KC_TRNS,KC_RALT,KC_RGUI,KC_RCTL
    ),
	[_GAMFUN] = LAYOUT(
    /******* FUNCTION Layer **************************************************************
     * ,-----------------------------------.              ,-----------------------------------.
    ...
    KC_TRNS,KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,        KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,
    KC_TRNS,KC_TRNS,KC_TRNS,KC_NO,  KC_TRNS,KC_NO,        KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO
    ),
	[_GAMNUM] = LAYOUT(
    /******* SYMBOL Layer **************************************************************
     * ,-----------------------------------.              ,-----------------------------------.
     ...
     */
     ...
     KC_TRNS,KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,     KC_NO,  KC_P1,  KC_P2,  KC_P3,  KC_EQL, KC_RSFT,
